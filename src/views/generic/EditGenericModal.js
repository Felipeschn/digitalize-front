...
function EditGenericModal({ generic, open, handleClose, refreshList }) {
  const [title, setTitle] = useState(generic.title)
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      await api.put(`/docfile/${generic.docFileId}/update`, {
        title,
        description,
        docType: 'generic',
      })
