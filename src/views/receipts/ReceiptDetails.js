...
function ReceiptDetails({ receipt, refreshList }) {
  ...
  const deleteNotation = async () => {
    await api.delete(`docfile/${receipt.docFileId}/delete`)
    refreshList()
  }
    ...
    <>
      ...
      >
        ...
        <CCard style={{ minHeight: '30pc', overflow: 'auto' }}>
          <CCardBody>
            <CCardText>{receipt.description}</CCardText>
            <FileViewer url={receipt.bucketUrl} />
          </CCardBody>
        </CCard>
      </CContainer>
      <CModal
